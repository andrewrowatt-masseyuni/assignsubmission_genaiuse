...
/**
 * Provides the information to restore Generative AI use statement submissions
 *
 * @package    assignsubmission_genaiuse
 * @copyright  2026 Andrew Rowatt <A.J.Rowatt@massey.ac.nz>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_genaiuse_subplugin extends restore_subplugin {
    /**
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_genaiuse');
    ...
    /**
     * Processes one assignsubmission_genaiuse element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_genaiuse_submission($data) {
        global $DB;
